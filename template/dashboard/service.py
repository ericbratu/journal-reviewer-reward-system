...
class SubnetStatsService:
    def __init__(
        ...
        self.netuid = netuid or os.getenv("SUBNET_NETUID")
        self.network = network or os.getenv("SUBNET_NETWORK")
    ...
    def _extract_entries_from_table(self, payload: str) -> List[SubnetEntry]:
        ...
        for line in lines:
            ...
            if "uid" in normalized_cells and any(
                cell in {"emission", "emissions"} for cell in normalized_cells
            ):
                header_cells = cells
                continue
